...
#define DEFAULT_FULLSCREEN   false
    ...
    || RETRO_PLATFORM == RETRO_UWP || RETRO_PLATFORM == RETRO_ANDROID || RETRO_PLATFORM == RETRO_LINUX || RETRO_PLATFORM == RETRO_PS2
...
#elif RETRO_PLATFORM == RETRO_LINUX || RETRO_PLATFORM == RETRO_PS2
...
#if RETRO_PLATFORM == RETRO_WIN || RETRO_PLATFORM == RETRO_UWP || RETRO_PLATFORM == RETRO_ANDROID || RETRO_PLATFORM == RETRO_LINUX || RETRO_PLATFORM == RETRO_PS2
#if RETRO_USING_SDL2
#include <SDL.h>
